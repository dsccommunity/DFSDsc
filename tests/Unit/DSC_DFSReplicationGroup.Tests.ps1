...
try
{
    ...
    InModuleScope $script:dscResourceName {
        ...
        Describe 'DSC_DFSReplicationGroup\Get-TargetResource' {
        ...
        Describe 'DSC_DFSReplicationGroup\Set-TargetResource' {
        ...
        Describe 'DSC_DFSReplicationGroup\Test-TargetResource' {
            Context 'Replication Group does not exist but should' {
                Mock Get-DfsReplicationGroup
                Mock Get-DfsrMember
                Mock Get-DfsReplicatedFolder
        ...
        Describe 'DSC_DFSReplicationGroup\Get-FQDNMemberName' {
